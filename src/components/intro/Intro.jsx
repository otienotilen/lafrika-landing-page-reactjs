import "./intro.css";
import Me from "../../img/Capture.PNG";
    ...
    <div id="intro" className="i">
      <div className="i-left">
        <div className="i-left-wrapper">
          <h2 className="i-intro">Media advertising agency</h2>
          <h1 className="i-name">Lafrika Media</h1>
          <div className="i-title">
            <div className="i-title-wrapper">
              <div className="i-title-item">Social media marketing</div>
              <div className="i-title-item">Content creation</div>
              <div className="i-title-item">Google ads</div>
              <div className="i-title-item">Conversion strategy</div>
